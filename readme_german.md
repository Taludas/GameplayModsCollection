...
* Unterstützung für neue Modloader-Funktionen und iMYA-Anpassung nach GU17 für alle Mods hinzugefügt:
  * Kaffee und Tabak in Enbesa ist nun auf einen Mod reduziert, der mit iMYA angepasst werden muss. Dort hat man die Möglichkeit, die gewünschte Version dieser Mod zu wählen (Verwendung von Baumwolltuch in NW, Verwendung von Leinen in NW, keine Verpackung, nur Farmen)
  * HighLife Souvenirs (Gold in einer Manufaktur)/LowLife Souvenirs (Verwendung von Messing in einer Fertigungsstraße): Wählt, welche Version ihr verwenden wollt (auch beide sind möglich!)
...
* Unterstützung für GU16 für alle Mods hinzugefügt.
* Kleinere Fehler mit Kaffee und Tabak in Enbesa behoben.
* Datei-Fehlplatzierung bei Alkaloid Collection und Museum, Zoo und Botanical Garden in Enbesa behoben, wo die Mods die Assets-Datei des anderen Mods hatten.
</details>

<details>
    <summary>Patch Notes Version 1.0</summary>

* Unterstützung für GU15 für alle Mods hinzugefügt.
* Kleinere Fehler mit Kaffee und Tabak in Enbesa behoben, bei denen die Tabakplantage aufgrund eines fehlenden Eintrags im Baumenü nicht gebaut werden konnte, sowie Farmen und Produktionsgebäude nicht durch den Einflussbuff Captain of Industries gepuffert wurden.
...
* Cath: Ketemas Habour, Kahina habour, Qing/Bente Drops, Weltausstellung, Elder Quest, Expedition
* Kola:  Ketemas Habour, Kahina habour, Qing/Bente Drops, Weltausstellung, Shephard Quest, Expedition
* Yohimbe: Ketemas Habour, Kahina habour, Qing/Bente Drops, Weltausstellung, Elder Quest, Expedition
* Koka: Samento Habour, Jornalero Quest, Qing/Bente Drop, Weltausstellung, Expedition
* Papaver: Elder Quest, Bente/Qing Drop, Weltausstellung, Expedition
</details>
